...
class FeatExtractor():
    ...
    def __init__(self,
        ...
        if type(lib_aa_composition) == dict: self.lib_aa_composition = lib_aa_composition
        else: self.lib_aa_composition = self.get_aa_composition(lib_aa_composition)
